...
public class UserController {
    ...
    public ResponseEntity<?> login(@RequestBody User user) {
        ...
        this.springCookie = ResponseCookie.from("user-id", String.valueOf(id))
                .path("/")
                .maxAge(60000)
                .domain("localhost")
                .build();
    ...
    public ResponseEntity<?> logout(@CookieValue(name = "user-id", defaultValue = "-1") String userId) {
        ...
        this.springCookie = ResponseCookie
                .from("user-id", "-1")
                .path("/")
                .maxAge(0)
                .domain("localhost")
        ...
        return ResponseEntity
                .ok()
                .header(HttpHeaders.SET_COOKIE, this.springCookie.toString())
                .build();
    }
